	...
	const dialogContents = confirming ? (
		...
		<div className="allowance-dialog">
			...
			<div className="allowance-message">
				<p>
					You need to allocate funds to upload and download on Hyperspace. Your
				...
				<p>
					...
					refill. If Hyperspace fails to refill the allowance by the end of the
				...
				<table className="estimates">
					<tr>
						...
						<td className="estimate-content">
							{new BigNumber(feeEstimate).round(2).toString()} XSC
						</td>
					</tr>
					<tr>
